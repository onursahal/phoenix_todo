...
config :phoenix_todo, PhoenixTodo.Repo,
  username: System.get_env("NEON_USERNAME"),
  password: System.get_env("NEON_PASSWORD"),
  hostname: System.get_env("NEON_HOST"),
...
config :phoenix_todo, PhoenixTodoWeb.Endpoint,
  ...
  secret_key_base: "OSP7G61P2JjvrGpCt1iOJAXQWnuMyOgS0dVZRPWEW3w1cIDIbSwj+8tipCPaz8gr",
  server: false
